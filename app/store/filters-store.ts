...
export const legislationFilters$ = new BehaviorSubject<LegislationFilters>(
  DEFAULT_FILTERS
);

export const updateLegislationFilters = async (
  newFilters: Partial<LegislationFilters>
) => {
